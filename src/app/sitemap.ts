...
const STATIC_PATHS = [
  ...
  { path: "/blog/singapore-buyers-stamp-duty-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/hong-kong-stamp-duty-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/wales-ltt-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/scotland-lbtt-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/toronto-land-transfer-tax-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/amazon-fba-fees-uk-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/amazon-fba-fees-canada-guide", changeFrequency: "monthly" as const, priority: 0.5 },
  { path: "/blog/utm-builder-for-shopify", changeFrequency: "monthly" as const, priority: 0.5 },
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const entries: MetadataRoute.Sitemap = [
    ...
    ...TOOL_PATHS.map((path) => ({
      ...
      priority: path.startsWith("/text/") || path === "/finance/net-salary-calculator" || path === "/finance/tip-calculator" || path === "/health/us-navy-body-fat-calculator" || path === "/utility/fuel-cost-calculator" || path === "/utility/gas-mileage-calculator" || path === "/utility/gpa-calculator" || path === "/utility/social-media-image-resizer" || path === "/utility/aspect-ratio-calculator" || path === "/utility/what-is-my-ip" || path === "/utility/utm-builder" ? 0.9 : 0.8,
    })),
  ];
