...
export const metadata: Metadata = {
  title: "Australia Income Tax Calculator 2025–26 — ATO Tax Rates",
  description:
    "Free Australia income tax calculator for FY 2025–26. Includes Stage 3 tax cuts, Medicare levy, LITO offset, HECS-HELP repayment, and superannuation. Accurate ATO rates for residents, non-residents and working holiday makers.",
  keywords: [
    "australia income tax calculator",
    "australian tax calculator 2025 25",
    "ato tax calculator",
    "how much tax do i pay australia",
    "income tax calculator australia 2025",
    "medicare levy calculator australia",
    "hecs help repayment calculator",
    "stage 3 tax cuts calculator",
    "take home pay calculator australia",
    "australian tax brackets 2025",
  ...
  openGraph: {
    ...
    description:
      "Calculate your Australian income tax, Medicare levy, HECS-HELP repayment and take-home pay for FY 2025–26. Includes Stage 3 tax cuts.",
...
const schema = {
  ...
  name: "Australia Income Tax Calculator 2025–26",
  applicationCategory: "FinanceApplication",
  operatingSystem: "Web",
  offers: { "@type": "Offer", price: "0", priceCurrency: "AUD" },
  description:
    "Free Australia income tax calculator for FY 2025–26 with Stage 3 tax cuts, Medicare levy, LITO, HECS-HELP and superannuation.",
  areaServed: "AU",
};

// ─── Content data ──────────────────────────────────────────────────

const TAX_BRACKETS_2025_25 = [
...
const FAQS = [
  {
    ...
    a: "Australia uses a progressive tax system — meaning higher income is taxed at higher rates, but only on the portion that falls within each bracket. For FY 2025–26, the first $18,200 is tax-free (the tax-free threshold). Income between $18,201 and $45,000 is taxed at 19%. Income from $45,001 to $120,000 is taxed at 32.5%. Income from $120,001 to $180,000 is taxed at 37%. Everything above $180,000 is taxed at 45%. The 45% rate doesn't apply to all your income — only the slice above $180,000. On top of income tax, most residents also pay the 2% Medicare levy.",
  },
  {
    q: "What are the Stage 3 tax cuts and how do they affect me?",
    a: "The Stage 3 tax cuts took effect from 1 July 2025 (FY 2025–26) and restructured Australia's middle income tax brackets. The key changes from the previous year: the 19% bracket was extended from $37,000 to $45,000; the 32.5% bracket was extended from $90,000 to $120,000; the 37% bracket was compressed; and the top 45% rate threshold remained at $180,001. The effect is a tax reduction for most Australians earning between $18,000 and $150,000. A person earning $80,000 saves approximately $1,679 per year compared to 2025–25 rates. Someone on $120,000 saves around $804.",
  },
  {
    q: "What is the Medicare levy and who pays it?",
    a: "The Medicare levy is a 2% charge on taxable income that funds Australia's public healthcare system (Medicare). It applies to most Australian tax residents. You are exempt if your income is below $26,000 (singles threshold 2025–26), with a phase-in between $26,000 and $32,500 where you pay a reduced levy. You may also be exempt if you hold certain visa types or have an exemption certificate for medical reasons. The Medicare Levy Surcharge (MLS) is an additional 1% charged to higher-income earners (above $93,000 singles, 2025–26) who do not hold private hospital cover — it is designed to encourage uptake of private health insurance.",
  },
  {
    q: "What is the Low Income Tax Offset (LITO)?",
    a: "The Low Income Tax Offset (LITO) is an offset that reduces the tax payable by low-income earners. For 2025–26: if your income is $37,500 or below, you receive the full $700 offset. Between $37,501 and $45,000, the offset phases out at 5 cents per dollar. Between $45,001 and $66,667, it phases out at 1.5 cents per dollar. Above $66,667 there is no offset. The LITO is not a cash payment — it reduces your tax bill. Combined with the tax-free threshold, it means you effectively pay no income tax until your income exceeds approximately $21,885 (where the full LITO exactly offsets the tax on income from $18,201 to that point).",
  },
  {
    q: "How does HECS-HELP repayment work?",
    a: "HECS-HELP debt is repaid compulsorily through the tax system once your income exceeds the repayment threshold, which is $54,435 for 2025–26. The repayment is a percentage of your total income — not just the amount above the threshold. Rates start at 1% and increase progressively to 10% for incomes above $159,664. For example, on a $70,000 income the repayment rate is 3%, meaning $2,100 is deducted annually. Repayments are made through your tax return (or PAYG withholding if you notify your employer). Your HELP debt also indexation each year on 1 June, tied to the Consumer Price Index (CPI) — in 2023 this was 7.1%, significantly increasing many balances.",
  },
  {
    q: "What is the Superannuation Guarantee and does it reduce my take-home pay?",
    a: "The Superannuation Guarantee (SG) is the minimum percentage of your ordinary time earnings that your employer must contribute to your superannuation fund. For 2025–26 the rate is 11.5%, rising to 12% from 1 July 2025. Importantly, employer super contributions are paid in addition to your salary — they do not reduce your take-home pay. If your salary is $80,000, your employer pays an additional $9,200 per year into your super fund. These contributions are taxed at 15% inside the fund (the concessional contributions tax rate), which is lower than most people's marginal tax rate, making super an extremely tax-efficient savings vehicle.",
  },
  {
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="mb-8 max-w-2xl">
          <div className="inline-flex items-center gap-2 bg-yellow-50 text-yellow-700 text-xs font-medium px-3 py-1.5 rounded-full mb-4">
            ...
            FY 2025–26 · Stage 3 cuts · ATO rates · Free
          </div>
          ...
          <p className="text-lg text-stone-500 leading-relaxed">
            ...
            and take-home pay for the 2025–26 financial year. Accurate ATO tax brackets
        ...
        <H2>Australian income tax rates 2025–26</H2>
        <P>
          ...
          2025–26 financial year (1 July 2025 to 30 June 2025) reflects the Stage 3
        ...
        <H2>The Stage 3 tax cuts — what changed from 1 July 2025</H2>
        <P>
          The most significant change to Australian income tax in over a decade took effect
          at the start of FY 2025–26. The Stage 3 tax cuts, legislated by the Albanese
        ...
        <P>
          ...
          to the 2025–25 rates. The cuts were designed to reduce bracket creep — the phenomenon
        ...
        <P>
          ...
          hospital cover. The singles threshold is $93,000 for 2025–26. The purpose is to
        ...
        <P>
          ...
          (2025–26). The repayment is calculated as a percentage of your total income,
        ...
        <div className="mt-10 p-4 bg-stone-50 rounded-xl border border-stone-200">
          <p className="text-xs text-stone-500 leading-relaxed">
            ...
            ATO tax rates and thresholds for the 2025–26 financial year. It is provided
