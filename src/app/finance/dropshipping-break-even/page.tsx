      ...
      <main className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <section className="mb-16" id="methodology">
            ...
            <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6">
              Benchmark data is compiled from WordStream, Store Growers, Usermaven, and aggregated client performance data reflecting 2026–2026 Google Ads and Meta Ads performance . Cost structures are validated against Shopify, AliExpress, and dropshipping platform documentation . The calculator does not store or transmit user data — all calculations occur client-side in the browser.
            </p>
          ...
          <section className="mb-16" id="references">
            ...
            <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <li>[40] <cite>RaptorKit</cite>. "Free Dropshipping Calculator: Profit, Margin & RTO Calculator." July 2026. <a href="https://raptorkit.com/dropshipping-calculator/" className="text-amber-600 hover:underline" target="_blank" rel="noopener noreferrer">https://raptorkit.com/...</a></li>
              ...
              <li>[42] <cite>TrueProfit</cite>. "Free Dropshipping Profit Calculator: Maximize Your Profits." April 2026. <a href="https://trueprofit.io/tools/dropshipping-profit-margin-calculator" className="text-amber-600 hover:underline" target="_blank" rel="noopener noreferrer">https://trueprofit.io/...</a></li>
