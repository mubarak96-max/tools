    ...
    <div className="space-y-8">
      ...
      <section className="glass-card rounded-[2rem] border border-border/80 p-8 sm:p-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          ...
          >
            <h3 className="font-bold text-foreground group-hover:text-primary transition-colors">Readability Calculator</h3>
            <p className="mt-2 text-xs text-muted-foreground">Check grade level and reading ease after rewriting.</p>
          </Link>
          <Link
            href="/text/duplicate-word-finder"
            className="group p-6 rounded-2xl border border-border bg-background hover:border-primary/20 transition-all hover:shadow-md"
          >
            <h3 className="font-bold text-foreground group-hover:text-primary transition-colors">Duplicate Word Finder</h3>
            <p className="mt-2 text-xs text-muted-foreground">Spot repeated terms before publishing your draft.</p>
          </Link>
          <Link
            href="/ai"
            className="group p-6 rounded-2xl border border-border bg-background hover:border-primary/20 transition-all hover:shadow-md"
