      ...
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_20rem]">
        ...
        <div className="glass-card rounded-[1.5rem] border border-border/80 p-5">
          ...
          <div className="mt-4 grid gap-2 text-sm">
            <Link href="/real-estate/nyc-transfer-tax-calculator" className="rounded-xl border border-border px-3 py-2 text-foreground hover:border-primary">
              NYC transfer tax
            </Link>
            <Link href="/real-estate/uk-stamp-duty-calculator" className="rounded-xl border border-border px-3 py-2 text-foreground hover:border-primary">
              UK stamp duty
            </Link>
            <Link href="/real-estate/singapore-property-stamp-duty-calculator" className="rounded-xl border border-border px-3 py-2 text-foreground hover:border-primary">
              Singapore stamp duty
            </Link>
            <Link href="/finance/invoice-generator" className="rounded-xl border border-border px-3 py-2 text-foreground hover:border-primary">
              Invoice generator
            </Link>
          </div>
        </div>
