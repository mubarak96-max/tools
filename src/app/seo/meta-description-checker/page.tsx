        ...
        <article className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <section className="mb-16" id="methodology">
            ...
            <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-6">
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-4 leading-relaxed">
                Independent developer and technical SEO specialist. This tool is maintained actively and updated quarterly to reflect changes in Google's SERP rendering behavior, font stacks, and display limits.
              </p>
          ...
          <section className="mb-16" id="references">
            ...
            <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <li>[15] <cite>MRS Digital</cite>. "Meta Length Checker - SERP Preview Tool 2026." December 2026. <a href="https://mrs.digital/tools/meta-length-checker/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://mrs.digital/...</a></li>
              ...
              <li>[20] <cite>Straight North</cite>. "How to Optimize Title Tags & Meta Descriptions in 2026." December 2026. <a href="https://www.straightnorth.com/blog/title-tags-and-meta-descriptions-how-to-write-and-optimize-them-in-2026/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://www.straightnorth.com/...</a></li>
