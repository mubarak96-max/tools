...
export const metadata: Metadata = {
  title: 'Free UTM Builder & Google Analytics URL Builder — Campaign URL Generator (2026)',
  description:
  ...
  alternates: {
    canonical: 'https://findbest.tools/utility/utm-builder',
  },
  openGraph: {
    title: 'Free UTM Builder & Google Analytics Campaign URL Generator',
    description: 'Build perfect tracking URLs with our campaign URL builder. Includes bulk generation, preset sources/mediums, and automatic validation.',
    url: 'https://findbest.tools/utility/utm-builder',
  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'To create a Google campaign URL, you must include three required parameters: utm_source (the referrer), utm_medium (the marketing channel), and utm_campaign (the promotion name). Optionally, add utm_term for paid search keywords and utm_content for A/B testing. Use lowercase letters, avoid spaces (use underscores or hyphens), and keep naming conventions consistent across your team. Our Google Analytics URL builder validates your input and provides preset values to prevent errors.',
        },
      },
      {
        '@type': 'Question',
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      >
        ...
        <div className="mt-16 space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <h3 className="font-bold text-red-700 mb-2 flex items-center gap-2">
                  <span>❌</span> Using UTM on Internal Links
                </h3>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <h3 className="font-bold text-red-700 mb-2 flex items-center gap-2">
                  <span>❌</span> Inconsistent Capitalization
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <h3 className="font-bold text-red-700 mb-2 flex items-center gap-2">
                  <span>❌</span> Mixing UTM with Auto-Tagging
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Google Ads auto-tagging (gclid) and manual UTM parameters create conflicting session data. Enable one or the other, never both. If you need UTM values in GA4 for Google Ads, use the &quot;Allow manual tagging&quot; override in property settings.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm">
                <h3 className="font-bold text-red-700 mb-2 flex items-center gap-2">
                  <span>❌</span> Including Spaces or Special Characters
                </h3>
                <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                <h3 className="font-bold text-slate-900 mb-2">Meta (Facebook & Instagram) Ads</h3>
                <p className="text-sm text-slate-600 leading-relaxed">
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Prefer auto-tagging (gclid) for Google Ads, but if you must use manual UTM tags, set <code>utm_source=google</code>, <code>utm_medium=cpc</code>, and use <code>utm_term={'{keyword}'}</code> to capture the keyword. Disable auto-tagging in your Google Ads account settings to prevent data conflicts.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
          ...
          {/* RELATED TOOLS */}
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-6">Related Marketing & Utility Tools</h2>
          ...
          <section className="bg-slate-900 text-slate-300 rounded-2xl p-8 lg:p-10">
            <h2 className="text-xl font-bold text-white mb-4">About This UTM Campaign Builder & Editorial Standards</h2>
            <div className="space-y-4 text-sm leading-7">
              ...
              <p>
                <strong>Last Updated:</strong> April 2026. Compatible with Google Analytics 4, Universal Analytics (legacy), Adobe Analytics (via s.campaign), and Mixpanel (via super properties).
              </p>
            </div>
          </section>
        </div>
