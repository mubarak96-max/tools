    ...
    <div className="container mx-auto max-w-7xl space-y-8 px-4 py-8">
      ...
      <section className="glass-card rounded-[1.75rem] border border-border/80 p-6 sm:p-8">
        <div className="prose prose-slate max-w-none">
          ...
          <p className="mt-3 text-base leading-7 text-muted-foreground">
            ...
            <Link href="/text/word-frequency" className="font-medium text-primary hover:underline">
              word frequency counter
            </Link>
            ,{" "}
            <Link href="/text/readability-flesch-kincaid-calculator" className="font-medium text-primary hover:underline">
              readability calculator
            </Link>
            , or browse every free app from the{" "}
      ...
      <section className="mt-16 space-y-8 border-t border-slate-100 pt-16">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">More Utility Tools</h2>
