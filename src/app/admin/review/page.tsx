            ...
            <tbody>
              {reviewRows.map((row) => {
                ...
                <tr key={`${row.type}-${row.slug}`} className="border-b border-border/60 last:border-b-0">
                  ...
                  <td className="px-4 py-4 text-sm text-muted-foreground">{row.confidence}</td>
                  <td className="px-4 py-4">
                  ...
                  <td className="px-4 py-4 text-right">
                    <div className="flex flex-wrap justify-end gap-2">
                      ...
                      <form action={actions.reject}>
                        <button
                          type="submit"
                          className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-3 py-2 text-xs font-semibold text-muted-foreground"
                        >
                          Return to draft
                        </button>
                      </form>
