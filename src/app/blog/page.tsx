...
const posts = [
  {
    ...
    description: "Understand Singapore buyer's stamp duty with a practical guide to BSD, ABSD, buyer profiles, and upfront property tax planning.",
    href: "/blog/singapore-buyers-stamp-duty-guide",
    tag: "Singapore Real Estate",
    readTime: "7 min read",
    date: "May 2026",
  },
  {
    title: "Hong Kong Stamp Duty Guide: How Residential Duty Is Calculated",
    description: "Learn how Hong Kong residential stamp duty works, why Scale 2 matters, and when a band-based estimate is better than a flat percentage shortcut.",
    href: "/blog/hong-kong-stamp-duty-guide",
    tag: "Hong Kong Real Estate",
    readTime: "6 min read",
    date: "May 2026",
  },
  {
    title: "Wales LTT Guide: Standard Rates vs Higher Rates",
    description: "Understand Welsh Land Transaction Tax, when higher rates apply, and how to estimate the tax before exchange.",
    href: "/blog/wales-ltt-guide",
    tag: "Wales Property Tax",
    readTime: "6 min read",
    date: "May 2026",
  },
  {
    title: "Scotland LBTT Guide: First-Time Buyer Relief and ADS",
    description: "Learn how Scotland LBTT works, when Additional Dwelling Supplement applies, and how to estimate the tax before buying.",
    href: "/blog/scotland-lbtt-guide",
    tag: "Scotland Property Tax",
    readTime: "6 min read",
    date: "May 2026",
  },
  {
    title: "Toronto Land Transfer Tax Guide: Ontario LTT, MLTT, and Rebates",
    description: "Understand Toronto land transfer tax, Ontario LTT, Toronto MLTT, first-time buyer rebates, and NRST before you budget a purchase.",
  ...
  },
  {
    ...
    description: "A practical guide to Amazon UK seller fees, VAT, storage, and break-even margin planning before you launch a SKU.",
    href: "/blog/amazon-fba-fees-uk-guide",
    tag: "Amazon UK",
    readTime: "7 min read",
    date: "May 2026",
  },
  {
    ...
    description: "Understand Amazon.ca referral fees, metric size tiers, storage, and CAD-based unit economics for Canadian sellers.",
    href: "/blog/amazon-fba-fees-canada-guide",
    tag: "Amazon Canada",
    readTime: "7 min read",
    date: "May 2026",
  },
  {
    ...
    description: "Learn how Shopify stores should tag product, collection, email, and paid social links for cleaner GA4 attribution.",
