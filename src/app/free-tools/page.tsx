    ...
    <div className="space-y-10">
      <section className="glass-card rounded-[2rem] border border-border/80 p-8 sm:p-10">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
          ...
          Start with salary, loan, and mortgage workflows, then move into more focused finance tools over time.
        </p>
      </section>
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">
                {category === "Finance" ? "Financial calculators" : `${category} tools`}
              </h2>
            </div>
