...
export const metadata = buildMetadata({
  title: "Text Tools for Analysis and Cleanup",
  description:
    "Use text tools for frequency analysis and lightweight content review workflows.",
  path: "/text",
});
    ...
    <div className="space-y-10">
      <section className="glass-card rounded-[2rem] border border-border/80 p-8 sm:p-10">
        ...
        <h1 className="mt-5 max-w-3xl text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">
          Text tools for quick content analysis.
        </h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
          Focused utilities for analyzing copy, repeated terms, and content structure without routing through a
          generic tools folder.
        </p>
      </section>
