...
export const EXACT_CONVERTER_TOOLS = [
  ...
  converter({ slug: "base64-encoder", name: "Base64 Encoder", description: "Encode text or files into Base64, switch to decode mode, and generate raw, data URL, or URL-safe output.", category: "Converter", icon: "B64", family: "encoding", mode: "base64-encode" }),
  converter({ slug: "base64-decoder", name: "Base64 Decoder", description: "Decode Base64 back into text or bytes, inspect size overhead, and preview supported decoded content.", category: "Converter", icon: "B64", family: "encoding", mode: "base64-decode" }),
